                ...
                <div
                    ...
                    <form class="text-start" method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <div class="mb-4">
                                <button type="submit"
                                    class="inline-block w-full px-5 py-2 text-base tracking-wide text-center text-white align-middle duration-500 bg-blue-600 border border-blue-600 rounded-md hover:bg-blue-700 hover:border-blue-700">{{ __('Reset Password') }}</button>
                            </div>
