    ...
    <section class="relative py-16 md:py-24">
        <div class="container relative mt-16 md:mt-24">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="md:col-span-6">
                    <div class="lg:ms-5">
                        <h6 class="mb-2 text-sm font-bold text-indigo-600 uppercase">Fast & Effective</h6>
                        <h3 class="mb-4 text-2xl font-semibold leading-normal md:text-3xl md:leading-normal">Powerful
                            Digitalization <br> With NACL</h3>

                        <p class="max-w-xl mb-6 text-slate-400">Get instant helpful resources about anything on the go,
                            easily implement secure money transfer solutions, boost your daily efficiency, connect to
                            other app users and create your own NACL network, and much more with just a few taps.
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="md:col-span-6 order2 md:order-1">
                    <div class="lg:me-5">
                        ...
                        <h3 class="mb-4 text-2xl font-semibold leading-normal md:text-3xl md:leading-normal">NACL
